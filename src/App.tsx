  ...
  {/* -------------- ABOUT --------------- */}
      ...
      <div id="schedule" className="md:mb-28 h-full flex flex-col scroll-mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-10 mb-10 mx-4 lg:mx-40">
          ...
          <div className="bg-black flex flex-col items-center rounded-lg">
            ...
            <button className="mt-9 md:mt-5 bg-black hover:scale-110 text-white text-left rounded-lg p-3 h-20 w-full">
              <div className="flex justify-between">
            ...
            <button className="mt-3 md:mt-0 bg-black hover:scale-110 text-white text-left rounded-lg p-3 h-20 w-full">
              <div className="flex justify-between">
            ...
            <button className="mt-4 md:mt-1 bg-black hover:scale-110 text-white text-left rounded-lg p-3 h-20 w-full">
              <div className="flex justify-between">
          ...
          <button className="relative text-center text-md bg-black text-yellow-300/85 text-2xl font-bold align-top rounded-xl outline outline-yellow-300/85 h-16 w-52">Saturday 9/21</button>
            ...
            <button className="md:mt-0 mt-4 bg-black hover:scale-110 text-white text-left rounded-lg p-3 h-20 w-full">
              <div className="flex justify-between">
            ...
            <button className="md:mt-0 mt-3 bg-black hover:scale-110 text-white text-left rounded-lg p-3 h-20 w-full">
              <div className="flex justify-between">
          ...
          <div className="md:mt-0 mt-10 bg-black flex flex-col items-center rounded-lg">
            ...
            <button className="mt-10 md:mt-5 bg-black hover:scale-110 text-white text-left rounded-lg p-3 h-20 w-full">
              <div className="flex justify-between">
      ...
      <h2 className=" text-orange-800 font-extrabold text-xl text-center mt-5">
        ...
        <div className = "flex flex-col md:w-full mx-auto">
          <div className = "grid grid-cols-1 md:grid-cols-4 mt-8 md:gap-x-12">
             {/* --------------- ROW 1 --------------- */}
