  ...
  return (
    <nav className="bg-black p-4 fixed top-0 left-0 w-full z-10">
      <ul className="flex space-x-8 text-white font-semibold ml-7">
        ...
        <li className="relative group">
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSd1gADwnj7PzFoeItHl3euH8QRYT42ywjV5bWp0hLXvaCtIww/viewform?usp=sf_link" target="_blank" rel="noreferrer" className="text-white">Apply</a>
          <span className="absolute left-0 bottom-0 w-full h-0.5 bg-white scale-x-0 group-hover:scale-x-100 transform transition-transform origin-left"></span>
        </li>
      </ul>
    </nav>
