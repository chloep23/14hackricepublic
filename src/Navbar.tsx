  ...
  return (
    <nav className="flex justify-between items-center bg-black h-16 w-screen p-4 fixed top-0 left-0 z-10">
      <div className="text-white font-semibold">
        ...
        <ul className={`md:flex ${isOpen ? "block" : "hidden"} md:block h-72 space-y-4 md:space-y-0 md:space-x-8 ml-5 mt-4 md:mt-0 z-10 bg-black md:bg-transparent w-full md:w-auto absolute md:static left-0`}>
